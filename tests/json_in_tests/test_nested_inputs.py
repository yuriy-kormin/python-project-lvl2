...
@pytest.mark.parametrize('get_result', ({"file_type": 'nested', "formatter": 'stylish'},
                                        {"file_type": 'nested', "formatter": 'stylish', 'reverse': True},
                                        {"file_type": 'nested', "formatter": 'plain'},
                                        {"file_type": 'nested', "formatter": 'plain', 'reverse': True},
                                        {"file_type": 'nested', "formatter": 'json'},
                                        {"file_type": 'nested', "formatter": 'json', 'reverse': True}
                                        ), indirect=True)
def test_nested(get_result):
